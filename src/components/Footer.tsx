...
export default function LogiQuestFooter() {
    ...
    return (
        <footer className="bg-black text-white">
            {/* Main Footer Content */}
            <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-8 sm:py-12 lg:py-16">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-12">
                    {/* Logo Section */}
                    <div className="space-y-4 sm:space-y-6 flex justify-center sm:justify-start">
                    ...
                    <div className="sm:col-span-2 lg:col-span-1">
                        ...
                        <div className="flex flex-col sm:flex-row gap-3">
                            <a
                                href="#"
                                className="inline-flex items-center justify-center px-4 py-2.5 bg-transparent border border-gray-600 rounded-lg hover:border-gray-500 transition-colors"
                            >
                                <svg
                            ...
                            >
                                ...
                                >
                                    <path
                                        d="M3 20.5V3.5L13.5 12L3 20.5Z"
                                        fill="#4CAF50"
                                    />
                                    <path
                                        d="M13.5 12L3 20.5L18.5 13L13.5 12Z"
                                        fill="#FFC107"
                                    />
                                    <path
                                        d="M18.5 11L3 3.5L13.5 12L18.5 11Z"
                                        fill="#03A9F4"
                                    />
                                    <path
                                        d="M13.5 12L18.5 11L18.5 13L13.5 12Z"
                                        fill="#F44336"
                                    />
                                </svg>
                                <span className="text-sm font-medium text-white">
